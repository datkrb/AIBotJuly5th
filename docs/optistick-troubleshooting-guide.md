Article URL:
https://support.optisigns.com/hc/en-us/articles/40147900639891-OptiStick-Troubleshooting-Guide

Updated At:
2026-06-26T13:52:36Z
...
If you’ve got an OptiStick Player and you’re having issues, you’ve come to the right place. For first time setup, see our article on how to [Set Up the OptiStick Player](/hc/en-us/articles/27267311796243).
...
By default, an OptiStick Player has an [**Operational Schedule**](/hc/en-us/articles/28598173096723) built in to ensure it has 8 hours of downtime per day:
...
OptiSigns Players also support the [**Mobile Admin App**](/hc/en-us/articles/30003143806099) as a Remote Control. This is our ***top recommendation,*** as not only does it function as a true remote control (allowing you to control your players from anywhere), but it has numerous other features as well.
...
* Check your firewall settings, and ensure you’ve [**Whitelisted OptiSigns IP addresses and ports**](/hc/en-us/articles/360047275934).
...
When [**setting a schedule**](/hc/en-us/articles/360016981853), it's critical that the portal and device share the same time zone. If the time zones are not identical, it can cause your schedule to start at a different time than you'd like. The issue is usually the device's time zone.
...
* [**Gen 3 Device Scaling**](/hc/en-us/articles/28026588373139)
* [**Gen 2 Device Scaling**](/hc/en-us/articles/27607906766483)

### Designer or Template Sizing Issues

If using the [**Designer app**](/hc/en-us/articles/4404151402899)**,** try setting the canvas size to 960x540, or change the display size on Android.
