Article URL:
https://support.optisigns.com/hc/en-us/articles/45619214182803-How-to-Set-Up-an-Outlook-Calendar-App-with-Shared-Permissions

Updated At:
2025-10-17T16:01:18Z
...
While OptiSigns currently does not support showing multiple user calendars at once (see our [**Calendar Mix**](/hc/en-us/articles/4408052949139) app for doing that), it is possible to show those Resources. However, specific permissions will need to be granted via your Microsoft Admin account in order to do this.
...
From here, follow the normal instructions on [Setting Up a Microsoft Outlook Calendar with OptiSigns](/hc/en-us/articles/360036250853) to get your Calendar up and running.
