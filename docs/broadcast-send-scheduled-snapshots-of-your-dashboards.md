...
* **Microsoft Teams -** Input a Teams webhook URL. This will create a card in your Teams channel with the snapshots. For more on this, see [How to Get a Microsoft Teams Webhook URL for OptiSigns Broadcast](/hc/en-us/articles/55416186918163).
