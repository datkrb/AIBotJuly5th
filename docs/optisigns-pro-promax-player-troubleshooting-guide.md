Article URL:
https://support.optisigns.com/hc/en-us/articles/40736654972563-OptiSigns-Pro-ProMax-Player-Troubleshooting-Guide

Updated At:
2026-01-13T21:20:16Z
...
If you’ve got an OptiSigns Pro or ProMax Player and you’re having issues, you’ve come to the right place. For first time setup, see our [**Set Up the OptiSigns Pro Player**](/hc/en-us/articles/32272215514131) or [**Set Up the OptiSigns ProMax Player**](/hc/en-us/articles/38680194603155) articles. For more on the Pro or ProMax player features, see our [**Advanced Features**](/hc/en-us/articles/35577511423635) article.

---

## Best Practices

* Set up the [**Mobile Admin App**](/hc/en-us/articles/30003143806099). This will allow you to use numerous features remotely, including the Remote Keyboard app and remote monitoring.
...
* If the device still cannot connect to any network, [**contact our support team**](/hc/en-us/articles/35626165056787). After a bit of troubleshooting, you may be asked to submit an [**RMA request**](#RMAProcess)**.**
...
See our [**Pro/Pro Max Player Advanced Features**](/hc/en-us/articles/35577511423635) article for information on setting these up.
...
2. By using the ***collectDeviceLog*** [**Remote Command**](/hc/en-us/articles/4408658251027) from the OptiSigns portal. This will provide a download link that you can use to obtain the log:
...
See our [**Advanced Settings for the Pro/ProMax Player**](/hc/en-us/articles/35577511423635) article for more information.
...
See our article on [**how to install a root certificate and set up your internal website display**](/hc/en-us/articles/35184720136595) for more information.
