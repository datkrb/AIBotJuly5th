Article URL:
https://support.optisigns.com/hc/en-us/articles/43657735780627-User-Management-Example-Chain-Restaurant-or-Retail-Store-with-Multiple-Locations

Updated At:
2025-08-28T19:28:55Z
...
* Work with the [**Teams feature**](/hc/en-us/articles/360034883113)to create the appropriate user organizational structure;
* Use [**Folder Level Security**](/hc/en-us/articles/360044600474)to restrict to certain users based on their team;
* Create [**Custom Branding**](/hc/en-us/articles/1500000485202) for the OptiSigns portal,and [**Enforce Brand Guidelines**](/hc/en-us/articles/42313875427859)across your teams
...
The others, we don’t need to worry about for this example. For more on User Roles, see our article on [**Managing User Roles**](/hc/en-us/articles/360046356113).
...
* [**Custom Branding Settings**](/hc/en-us/articles/1500000485202)
* [**Brand Kit and Enforcing Brand Guidelines**](/hc/en-us/articles/42313875427859)
...
To add users via OptiSigns, go back to where you created the Teams. You can **Add** or **Invite** users from here. See [**Managing User Roles**](/hc/en-us/articles/360046356113)for more information.

However, for our example, our hypothetical restaurant chain wants to enforce SSO via SAML.

To do this, go to our [**SSO & SAML**](https://support.optisigns.com/hc/en-us/sections/26319189062803-SSO-SAML)section and follow the appropriate article. We highly recommend reading our [**SAML best practices**](/hc/en-us/articles/4407128433299)article, as well.
