Article URL:
https://support.optisigns.com/hc/en-us/articles/38062664690195-Tagging-in-OptiSigns

Updated At:
2025-09-09T19:34:07Z
...
| --- |
| **NOTE** |
| Asset and screen tagging are distinct from [**content tags in playlists**](/hc/en-us/articles/20879903340947). |
...
For more information on how to send Remote Commands via tag, see our article on [**Remote Command Execution**](/hc/en-us/articles/4408658251027).
...
Tags may only be applied to existing assets in OptiSigns. To learn how to create an asset, see our article on [**How to Upload and Manage Files and Assets**](/hc/en-us/articles/360016247974)**.**
